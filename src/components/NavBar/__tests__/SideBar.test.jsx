...
describe('Navigation Wrapper', () => {
  it('should display menu label when open', () => {
    render(
      <BrowserRouter>
  ...
  it('should change route to course when course is selected', () => {
    render(
      <BrowserRouter>
        <SideBar open handleClose={() => {}} drawerWidth={240} />
      </BrowserRouter>,
  ...
  it('should close sidebar when the chevron left icon is pressed', () => {
